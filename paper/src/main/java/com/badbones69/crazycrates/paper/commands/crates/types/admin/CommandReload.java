...
public class CommandReload extends BaseCommand {
    ...
    public void reload(CommandSender sender) {
        ...
        this.fileManager.refresh(false).addFile(this.path.resolve("locations.yml"), FileType.PAPER, new java.util.ArrayList<>(List.of(
                    FileAction.STATIC_FILE,
                    FileAction.RELOAD_FILE
                )), null)
                .addFile(this.path.resolve("data.yml"), FileType.PAPER, new java.util.ArrayList<>(List.of(
                        FileAction.STATIC_FILE,
                        FileAction.RELOAD_FILE
                )), null)
                .addFile(this.path.resolve("guis").resolve("respin-gui.yml"), FileType.PAPER, new java.util.ArrayList<>(List.of(
                        FileAction.STATIC_FILE,
                        FileAction.RELOAD_FILE
                )), null)
                .addFolder(this.path.resolve("logs"), FileType.LOG, new java.util.ArrayList<>(List.of(
                    FileAction.EXTRACT_FOLDER,
                    FileAction.STATIC_FILE,
                    FileAction.RELOAD_FILE
                )), null)
                .addFolder(this.path.resolve("crates"), FileType.PAPER, new java.util.ArrayList<>(List.of(
                        FileAction.EXTRACT_FOLDER
                )), null)
                .addFolder(this.path.resolve("schematics"), FileType.NBT, new java.util.ArrayList<>(List.of(
                        FileAction.EXTRACT_FOLDER
                )), null);
