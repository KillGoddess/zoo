...
public class CrateButton extends GuiButton {
    ...
    public CrateButton(@NotNull final Crate crate, @Nullable final Prize prize, @NotNull final ConfigurationSection section) {
        ...
        super(section, Map.of(
                "%crate_pretty%", crate.getCrateName() != null ? crate.getCrateName() : "Unknown",
                "%crate_raw%", crate.getFileName() != null ? crate.getFileName() : "unknown",
                "%prize%", prize != null && prize.getSectionName() != null ? prize.getSectionName() : "N/A"
        ));
